...
describe('ПОВОД ДЛЯ ПРАВКИ ЖИВ', () => {
  it('разбор адреса пишет расшифрованное вложение в файл — отсюда и цена', () => {
    ...
    // v4.32.875: разбор отдаёт не просто адрес, а исход целиком
    // (resolveBlobToLocalFileResult) — файл кэша он пишет ровно так же.
    expect(body).toContain("await resolveBlobToLocalFileResult(ref, 'img')");
  });
