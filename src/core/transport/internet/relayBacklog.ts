 ...
 * приложение вечером и открыл утром» — нет: relay держит накопленное, из
 * которого мы забирали десять минут, а остальное молча выбрасывали. Так
 * терялись и личные сообщения, и групповые, и публикации ленты: они едут одним
 * и тем же topic'ом.
 *
 ...
 * просить накопленное.
 *
 * v4.32.611. Было 12 часов — срок публичного ntfy.sh. Свой сервер держит 30
 * суток, чтобы сообщение дождалось того, кто не заходил неделю или месяц.
