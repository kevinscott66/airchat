...
class ProfileManager {
   ...
   *
   * Аватар — это файл в documentDirectory, а путь к нему лежал в kv удалённого
   * профиля и уже стёрт вместе с ним. Поэтому идём от живых: собираем их пути и
   * сносим всё остальное. Заодно подбираются файлы, осиротевшие в версиях до
   * этой, — до сих пор снимок лица удалённого аккаунта оставался на устройстве
   * навсегда.
   *
