...
const VECTORS: Vector[] = [
  ...
  ['12345', '12345', null],
  // v4.32.936: нижняя граница протокола — та, которую бумага не открывает.
  // Клиент держал её последним словом (и отвечал причиной «charset»), сервер
  // не держал вовсе: имя из двух букв по бумаге ложилось бы в реестр, откуда
  // приложение его всё равно не прочитает.
  ['ab', 'ab', null],
  ['a', 'a', null],
  ['a_', 'a_', null],
  // …а три символа бумага открывает: это граница протокола, а не выдачи.
  ['abc', 'abc', 'abc'],
