 ...
 *
 * v4.32.573: у АККАУНТА эта строка с экрана убрана. Показывать её человеку
 * оказалось лишним — рядом лежит адрес для связи, который и точнее, и уже
 * подписан, — но выводиться она не перестала: код читает её через
 * `core/identity/accountRef` (реф-код, дата заведения аккаунта). У группы и
 * канала строка на экране осталась: там ей на смену нечего предложить —
 * приглашение живёт ссылкой, а не ключом, и назвать канал вслух больше нечем.
 */
