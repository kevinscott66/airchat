...
function ChatThreadView({
  ...
  useEffect(() => {
    if (!peerB64) return;
    // v4.32.560: «Избранное» — переписка без собеседника, рассказывать о себе
    // здесь некому. Оба конверта уходили и сюда: отправка искала общий ключ со
    // «собеседником», не находила и встречала входящего в свои заметки
    // предложением добавить самого себя по QR-коду.
