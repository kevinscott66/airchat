    ...
    <SafeScreen edges={['left', 'right', 'top']} style={{ flex: 1 }}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            {isCloudVaultConfigured()
              ...
              : 'В этой версии приложения хранилище не задано: переписка, контакты и настройки лежат только здесь и никуда не уходят. Перед переустановкой и переездом на новый телефон сделайте резервную копию в настройках — иначе восстановить будет не из чего.'}
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardTitle}>Секретные слова и пароль</Text>
          <Text style={styles.cardText}>
            Секретные слова — это сам аккаунт: по ним он открывается на новом устройстве, и без них вход не
            восстановит никто, включая нас. Пароль приложения в AirChat один: он снимает замок с экрана,
            открывает секретные слова и им же шифруется копия на сервере. Запишите слова на бумаге и
            храните отдельно от телефона.
          </Text>
        </View>
      </ScrollView>
    </SafeScreen>
