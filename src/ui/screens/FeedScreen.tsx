        ...
        >
          <View style={styles.modalOverlay}>
            {/* v4.32.122: на Android используем flex:1 + marginTop=insets.top+8 — модалка
                ...
                одна — 0.72 экрана снизу, — а ограничивает её внутренняя область
                контейнера: лист сжимается до неё (`flexShrink`). Клавиатуру из неё вычитает
                ...
                style={[
                  ...
                  Platform.OS === 'ios'
                    ? {
                        ...
                        // Выше остатка контейнера лист не бывает: клавиатуру из
                        // него вычитает KeyboardAvoidingView, чёлку — `paddingTop`,
                        // а лист сжимается до того, что осталось. Флаг клавиатуры
                        // здесь не участвует — он приходит другим событием и
                        // расходился с отступом (v4.32.604).
                        //
                        // Сжатие, а не процентный `maxHeight`: с ним Yoga
                        // урезает высоту, но место под лист при `flex-end`
                        // считает от исходных 0.72 экрана. На iPhone 16 Plus это
                        // 518 pt листа, поставленные с −86 pt: шапка за кромкой, а
                        // между листом и клавиатурой 154 pt пустоты.
                        flexShrink: 1,
