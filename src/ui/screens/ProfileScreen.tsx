    ...
    <SafeScreen edges={['left', 'right']} style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      <ScrollView style={[styles.container, { backgroundColor: 'transparent' }]} contentContainerStyle={[styles.content, { paddingTop: insets.top + 16, paddingBottom: tabInset + 40 }]} testID="profile_screen">
        ...
        <View style={styles.avatarSection}>
          ...
          {/* v4.32.914: было «Ваш адрес для связи». Пустой список контактов
              на соседнем экране говорит буквально: «попросите друга открыть
              «Профиль» → «Мой QR-код», отсканируйте код или вставьте его ID»,
              — и присылает человека на этот экран искать ID, которого здесь
              не было ни одного. То же слово стоит на приёмной стороне
              («Ссылка или ID контакта») и в подтверждении копирования («ID
              скопирован», v4.32.469). «Адрес» оставлен группам: у группы
              публичный адрес — это другая вещь, и она правда адрес. */}
          ...
          <Text style={styles.userIdHint}>Нажмите, чтобы скопировать, или покажите QR-код — друг добавит вас, не набирая ID вручную.</Text>
        </View>
