 ...
 * истории, медиа, избранное, файлы, музыка, голосовые, ссылки, у себя — ещё
 * и архив публикаций) и настройки
...
/**
 * Разделы содержимого (состав — v4.32.577).
 *
 * Файлы, музыка, голосовые и ссылки вернулись в полосу, и вернулись не как
 * ярлыки. В 575-м их убрали потому, что каждая плашка открывала одну и ту же
 * галерею поверх карточки, просто сразу на своей вкладке: деление было
 * нарисовано дважды, в полосе и внутри галереи. Теперь галереи поверх
 * карточки нет — раздел разворачивается прямо в профиле, под полосой, — и
 * второго места, где то же деление повторяется, не осталось. Полоса и есть
 * те самые вкладки, просто на своём месте.
 *
 * Порядок — как человек читает профиль сверху вниз: сначала что человек
 * писал (стена) и что у него сейчас (истории), затем чем обменивались —
 * медиа, избранное, файлы, музыка, голосовые, ссылки. Полоса листается вбок,
 * поэтому длина ряда её не ломает: обрезанная плашка у края и есть подсказка,
