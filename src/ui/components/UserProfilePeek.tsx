...
// записью и блокировкой (core/social/contactReport); «Запрет на копирование»
// закрывает копирование внутри приложения, а не снимок экрана
// (core/social/copyGuard).
    ...
    const commit = (): void => {
      void setCopyGuard(pub, next)
        .then(() => {
          ...
          showSuccess(next ? 'Копирование выключено' : 'Копирование разрешено');
        })
